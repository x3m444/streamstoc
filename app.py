...
# --- Authentication ----------------------------------------------------------
# Require a valid password before showing any application content.
if not check_password():
    st.stop()

# --- Database integrity check ------------------------------------------------
# Verify the database connection and ensure the expected table exists.
engine = get_engine()
...
# --- Navigation menu ---------------------------------------------------------
# Display the main sidebar menu and route the user to the selected section.
